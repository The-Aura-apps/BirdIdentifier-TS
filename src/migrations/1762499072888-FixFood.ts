...
export class FixFood1762499072888 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bird_foods" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "bird_foods" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "bird_distributions" ADD "presenceScore" double precision`);
        ...
        await queryRunner.query(`ALTER TABLE "bird_foods" ALTER COLUMN "isActive" SET DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "bird_distributions" DROP CONSTRAINT "FK_94e21b289c7cc6bb9284d17ed37"`);
        await queryRunner.query(`ALTER TABLE "bird_distributions" ALTER COLUMN "bird_id" DROP NOT NULL`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_6bdce84921665f8443703f56b7" ON "bird_distributions" ("location") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "bird_distributions" ALTER COLUMN "bird_id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "bird_distributions" ADD CONSTRAINT "FK_94e21b289c7cc6bb9284d17ed37" FOREIGN KEY ("bird_id") REFERENCES "birds"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bird_foods" ALTER COLUMN "isActive" SET DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "bird_distributions" ADD "season" "public"."bird_distributions_season_enum" NOT NULL`);
