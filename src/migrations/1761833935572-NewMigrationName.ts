...
export class NewMigrationName1761833935572 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "media" ("id" SERIAL NOT NULL, "bird_id" integer NOT NULL, "storageKey" character varying(500) NOT NULL, "type" "public"."media_type_enum" NOT NULL DEFAULT 'photo', "size" character varying, "caption" character varying(255), "source" character varying(255), "attribution" character varying(255), "orderIndex" integer NOT NULL DEFAULT '0', "metadata" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f4e0fcac36e050de337b670d8bd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_b2b76ac9dc5261d88a5fec61ca" ON "media" ("bird_id", "orderIndex") `);
        await queryRunner.query(`CREATE INDEX "IDX_bb1235e82f7fccb9022e61311d" ON "media" ("bird_id", "type") `);
        ...
        await queryRunner.query(`CREATE TABLE "bird_foods" ("id" SERIAL NOT NULL, "bird_id" integer NOT NULL, "food_id" integer NOT NULL, "isActive" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_132e19a7434923cbab9ca6c3234" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_7c8d76a4530e449b670ad3fda0" ON "bird_foods" ("bird_id", "food_id") `);
        await queryRunner.query(`CREATE TABLE "common_names" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "language" character varying(10) NOT NULL DEFAULT 'en', "region" character varying NOT NULL, "bird_id" integer NOT NULL, CONSTRAINT "PK_47a1748c20d65a3b5aa528aa858" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e3198a9303ff141f77dae2cb15" ON "common_names" ("name") `);
        ...
        await queryRunner.query(`CREATE TABLE "bird_distributions" ("id" SERIAL NOT NULL, "bird_id" integer NOT NULL, "season" "public"."bird_distributions_season_enum" NOT NULL, "description" text, "countries" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2896a9bde192b15125a205d7920" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_6692b9d206044a0bc74c026956" ON "bird_distributions" ("bird_id", "season") `);
        await queryRunner.query(`CREATE TABLE "habitats" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "description" text, "iconUrl" character varying(500), CONSTRAINT "UQ_63cfbf4a9393c728c9673440298" UNIQUE ("name"), CONSTRAINT "PK_1d6e7a888814106d17f07d7d418" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "taxonomy" ADD CONSTRAINT "FK_7526afb959d2bd28bf9dabba059" FOREIGN KEY ("bird_id") REFERENCES "birds"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "taxonomy" DROP CONSTRAINT "FK_7526afb959d2bd28bf9dabba059"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_e3198a9303ff141f77dae2cb15"`);
